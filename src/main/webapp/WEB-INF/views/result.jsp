              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-sm table-dark">
                    ...
                    <tr>
                      <td>Basic Salary</td>
                      <td id="basic_salary_show"></td>
                      <td>
                        <span id="basic_salary_exemption"></span>
                      </td>
                      <td>
                        <span id="basic_salary_taxable"></span>
                      </td>
                    </tr>
                    <tr>
                      <td>House Rent</td>
                      <td id="houserent_show"></td>
                      <td>
                        <span id="houserent_exemption"></span>
                      </td>
                      <td>
                        <span id="houserent_taxable"></span>
                      </td>
                    </tr>
                    <tr>
                      <td>Medical Allowance</td>
                      <td id="medical_show"></td>
                      <td>
                        <span id="medical_exemption"></span>
                      </td>
                      <td>
                        <span id="medical_taxable"></span>
                      </td>
                    </tr>
                    <tr>
                      <td>Conveyance</td>
                      <td id="conveyance_show"></td>
                      <td>
                        <span id="conveyance_exemption"></span>
                      </td>
                      <td>
                        <span id="conveyance_taxable"></span>
                      </td>
                    </tr>
                    <tr>
                      <td>Incentive/OT</td>
                      <td id="commision_show"></td>
                      <td>
                        <span id="commision_exemption"></span>
                      </td>
                      <td>
                        <span id="commision_taxable"></span>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td id="bonus_show"></td>
                      <td>
                        <span id="bonus_exemption"></span>
                      </td>
                      <td>
                        <span id="bonus_taxable"></span>
                      </td>
                    </tr>
                    <tr>
                      <th>Total</th>
                      <td><span id="total_income2"></span></td>
                      <td>-</td>
                      <th>
                        <span id="total_taxable"></span>
                      </th>
                    </tr>
                    </tbody>
                  </table>
